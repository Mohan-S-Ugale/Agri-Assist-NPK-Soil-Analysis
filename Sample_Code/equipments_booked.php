...
<?php
        ...
        {
            extract($_POST);
                $query=mysqli_query($connect,"insert into product_enquiry (Product_id, En_customer_name, En_customer_email, En_customer_mobile, En_customer_address, From_date, To_date, No_of_days, Rent, Labour_rent, Total_rent) values('".$_GET['product_id']."', '$en_customer_name', '$en_customer_email','$en_customer_mobile','$en_customer_address','$from_date','$to_date','$no_of_days','$rent','$labour_rent','$total_rent')")or die (mysqli_error($connect));
